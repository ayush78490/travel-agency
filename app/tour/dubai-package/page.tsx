...
import EnquiryPage from "@/components/enqiry"
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 flex-1">BOOK NOW</Button>
                <Button
                  variant="outline"
            ...
            <div className="sticky top-4 space-y-6">
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button className="w-full bg-red-600 hover:bg-red-700 text-white py-3">BOOK NOW</Button>
